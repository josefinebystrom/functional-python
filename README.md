# Functional Python [![](https://github.com/josefinebystrom/functional-python/workflows/tests/badge.svg)](https://github.com/josefinebystrom/functional-python/actions?query=workflow%3Atests)
